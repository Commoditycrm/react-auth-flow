...
var EmailService = /** @class */ (function () {
    ...
    EmailService.prototype.sendEmail = function (emailDetail) {
        return __awaiter(this, void 0, void 0, function () {
            var sendgridMessage, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sendgridMessage = {
                            from: EmailService.instance.from,
                            templateId: env_loader_1.EnvLoader.getOrThrow("".concat(emailDetail.type, "_TEMPLATE_ID")),
                            personalizations: [
                                {
                                    to: emailDetail.to,
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, mail_1.default.send(sendgridMessage)];
                    case 2:
                        _a.sent();
